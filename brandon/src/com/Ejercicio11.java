...
public class Ejercicio11 {
	public static void main(String[] args) {
	    ...
	    if (peso > 5){
	      ...
	      switch (zona) {
	      case 1:
	        System.out.println("El paquete de " +peso+" kg enviado a América del Norte sale por " +(peso*24)+ " euros.");
	        break;
	      case 2:
	        System.out.println("El paquete de " +peso+ "kg enviado a América Central sale por " +(peso*20)+ " euros.");
	        break;
	      case 3:
	        System.out.println("El paquete de " +peso+ " kg enviado a América del Sur sale por " +(peso*21)+ " euros.");
	        break;
	      case 4:
	        System.out.println("El paquete de " +peso+ " kg enviado a Europa sale por " +(peso*10)+ " euros.");
	        break;
	      case 5:
	        System.out.println("El paquete de " +peso+ " kg enviado a Asia sale por " +(peso*18)+ " euros.");
	        break;
	      default:
