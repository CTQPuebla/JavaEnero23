...
public class Smartphone extends Celular {
	...
	public Smartphone(String marca, int botones, String materiales, String modelo, String color, String sistOperativo,
			Ram ram) {
		super(marca, botones, materiales, modelo, color);
		this.sistOperativo = sistOperativo;
		this.ram = ram;
	}
